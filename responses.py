...
def get_responses (user_input: str) -> str:
   ...
   if '!laptop' in lowered:
      return 'Fontos megtudni milyen felbontáson szeretnél játszani:\n -1080p: !lp1080\n -1440p: !lp1440\n -4k: !lp4k\nAz így kapott laptop konfigurációk mindig közepestől egészen a maximális grafikai beállításokat célozzák meg.'
   ...
   if '!lp4k' in lowered:
      return 'A 4k-t választottad. Fontos még, hogy milyen típusú játékokkal szeretnél játszani?\n -Ha csak fps úgynevezett E-sport játékokkal fogsz játszani akkor: /lp4kfps\n -Ha sztori játékokkal játszanál leginkább akkor: /lp4kst\n -Ha a kettő közötti arany középutat céloznád meg akkor pedig: /lp4kmid'
